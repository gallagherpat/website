...
export default function Page() {
    ...
    if(!load){
        return (<>
        <FullImage isModalOpen={isModalOpen} modalHandler={modalHandler} images={images} setCounter={setCounter} counter={counter} src={src}/>
...
export function FullImage(props) {
